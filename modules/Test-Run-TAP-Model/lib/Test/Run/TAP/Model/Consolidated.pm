...
package Test::Run::TAP::Model::Consolidated;
use base qw/Test::Run::TAP::Model/;
use List::Util ();

use strict;
use warnings;

use Test::Run::TAP::Model::File::Consolidated;
...
sub file_class { "Test::Run::TAP::Model::File::Consolidated" }
sub get_test_files {
	my $self = shift;
...
Test::Run::TAP::Model::Consolidated - The unification of several L<Test::Run::TAP::Model>
reports.
...
L<Test::Run::TAP::Model::Consolidated> is the same interface to Test::Run::TAP::Model
except that it provides an aggregate interface to result processing.

Using it with the L<Test::Run::Straps> kind of methods will not work.
