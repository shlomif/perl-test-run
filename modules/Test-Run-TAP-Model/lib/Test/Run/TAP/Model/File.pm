...
package Test::Run::TAP::Model::File;

use strict;
use warnings;

use Test::Run::TAP::Model::Subtest;
...
sub subtest_class { "Test::Run::TAP::Model::Subtest" }
...
Test::Run::TAP::Model::File - an object representing the TAP results of a single
...
ask about the hash structure described in L<Test::Run::TAP::Model>.
...
L<Test::Run::TAP::Model/structure>.
...
L<Test::Run::TAP::Model::Subtest> objects
